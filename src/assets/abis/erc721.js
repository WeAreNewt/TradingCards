export default [
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'createdTokenIds', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'ownedTokenIds', type: 'uint256[]' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'proxyCallContract', type: 'address' },
    ],
